...
<head>
    ...
    <title>Nuevo Municipio - Panel Administrativo</title>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1><i class="fas fa-plus me-2"></i>Nuevo Municipio</h1>
                        <p class="text-muted">Agregar un nuevo municipio al sistema</p>
                    </div>
                    <div>
